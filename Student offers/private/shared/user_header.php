  ...
  <header class="masthead">
    ...
    <div id="notification-header">
      <div style="position:relative">
        <div id="notification-icon" name="button" onclick="myFunction()" class="dropbtn"><span id="notification-count" style="color: red"><?php if($count>0) { echo "new"; } ?></span><i class="far fa-user-circle" style="font-size:30px;color:white"></i></div>
        ...
        <ul>
          ...
          <li class="sidebar">
            <section class="main-nav">
                <nav>
                  <ul>
                    <li style="" class="<?php if($pg=='post_offer'){?>active<?php }?>"><a style="font-weight:bold;background-color:#f4511e;border-radius:5px" href="<?php echo url_for('user/pages/post_offer.php')?>"><i class="fas fa-book-reader"></i>Post an Offer</a></li>

                    <li class="<?php if($pg=='list_all_offers'){?>active<?php }?>"><a href="<?php echo url_for('user/accept_offers/list_all_offers.php')?>"><i class="far fa-list-alt"></i>List all Offers</a></li>
                    ...
                    <li class="<?php if($pg=='personal_data'){?>active<?php }?>"><a href="<?php echo url_for('user/pages/personal_data.php')?>"><i class="far fa-address-card"></i>Personal Data</a></li>
